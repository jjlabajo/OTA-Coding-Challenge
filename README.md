...
3.  **Create Frontend Root Environment File:**
    * Create a new file named `.env.development.local` in the project root (`OTA-Coding-Challenge/frontend/.env.development.local`).
    ```env
    # OTA-Coding-Challenge/frontend/.env.development.local
...
5.  **Create DB Tables and fill in dummy data**
    ```bash
